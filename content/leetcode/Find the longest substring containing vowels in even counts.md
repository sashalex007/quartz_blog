...
**Review 2**
Got to the right approach pretty fast but spent a while thinking about a few edge cases that did not in fact exist (did not look at the examples). Solved it pretty fast once I stopped being lazy and looked at the example cases. Ruled out sliding window quite quickly, so that's a positive. 
