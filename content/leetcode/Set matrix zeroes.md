...
2. Set the zeros in the range `1-m, 1-n` using the flags. Reason we don't touch the first row and column is because our flags are there and we cannon overwrite them!
